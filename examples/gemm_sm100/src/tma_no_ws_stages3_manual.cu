...
extern "C" __global__ void __launch_bounds__(128, 1) gemm_kernel(__grid_constant__ const CUtensorMap A_desc, __grid_constant__ const CUtensorMap B_desc, __grid_constant__ const CUtensorMap C_desc) {
  ...
  __syncthreads();
  if (((int)threadIdx.x) == 0) {
    tl::tma_load(A_desc, mbarrier[0], (&(((bfloat16_t*)buf_dyn_shmem)[0])), 3712, (((int)blockIdx.y) * 128));
    tl::tma_load(A_desc, mbarrier[0], (&(((bfloat16_t*)buf_dyn_shmem)[8192])), 3776, (((int)blockIdx.y) * 128));
    tl::tma_load(B_desc, mbarrier[0], (&(((bfloat16_t*)buf_dyn_shmem)[16384])), (((int)blockIdx.x) * 128), 3712);
    tl::tma_load(B_desc, mbarrier[0], (&(((bfloat16_t*)buf_dyn_shmem)[24576])), ((((int)blockIdx.x) * 128) + 64), 3712);
  }
  __syncthreads();
  if ((((int)threadIdx.x) >> 5) == 0) {
    tl::initialize_tcgen05_descriptor(desc_a, (&(((bfloat16_t*)buf_dyn_shmem)[0])), 1, 64, 0, 0, 2);
    ...
    for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
      tl::tcgen05mma_ss<tl::DataType::kBFloat16>(uint64_t(desc_a + (((ki_1 >> 2) * 16384) + ((ki_1 & 3) * 32))), uint64_t(desc_b + (ki_1 * 2048)), (*reinterpret_cast<uint32_t*>(C_tmem)) + 0, 1, static_cast<uint32_t>(136381584), 0, 0, 0, 0);
    }
    tl::tcgen05_mma_arrive((&(mbar[0])));
  }
  mbar[0].wait(1);
  __syncthreads();
  if (((int)threadIdx.x) == 0) {
    tl::tma_load(A_desc, mbarrier[0], (&(((bfloat16_t*)buf_dyn_shmem)[0])), 3840, (((int)blockIdx.y) * 128));
    tl::tma_load(A_desc, mbarrier[0], (&(((bfloat16_t*)buf_dyn_shmem)[8192])), 3904, (((int)blockIdx.y) * 128));
    tl::tma_load(B_desc, mbarrier[0], (&(((bfloat16_t*)buf_dyn_shmem)[16384])), (((int)blockIdx.x) * 128), 3840);
    tl::tma_load(B_desc, mbarrier[0], (&(((bfloat16_t*)buf_dyn_shmem)[24576])), ((((int)blockIdx.x) * 128) + 64), 3840);
  }
  __syncthreads();
  if ((((int)threadIdx.x) >> 5) == 0) {
    tl::initialize_tcgen05_descriptor(desc_a, (&(((bfloat16_t*)buf_dyn_shmem)[0])), 1, 64, 0, 0, 2);
    ...
    for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
      tl::tcgen05mma_ss<tl::DataType::kBFloat16>(uint64_t(desc_a + (((ki_2 >> 2) * 16384) + ((ki_2 & 3) * 32))), uint64_t(desc_b + (ki_2 * 2048)), (*reinterpret_cast<uint32_t*>(C_tmem)) + 0, 1, static_cast<uint32_t>(136381584), 0, 0, 0, 0);
    }
    tl::tcgen05_mma_arrive((&(mbar[0])));
  }
  mbar[0].wait(0);
  __syncthreads();
  if (((int)threadIdx.x) == 0) {
    tl::tma_load(A_desc, mbarrier[0], (&(((bfloat16_t*)buf_dyn_shmem)[0])), 3968, (((int)blockIdx.y) * 128));
    tl::tma_load(A_desc, mbarrier[0], (&(((bfloat16_t*)buf_dyn_shmem)[8192])), 4032, (((int)blockIdx.y) * 128));
    tl::tma_load(B_desc, mbarrier[0], (&(((bfloat16_t*)buf_dyn_shmem)[16384])), (((int)blockIdx.x) * 128), 3968);
    tl::tma_load(B_desc, mbarrier[0], (&(((bfloat16_t*)buf_dyn_shmem)[24576])), ((((int)blockIdx.x) * 128) + 64), 3968);
  }
  __syncthreads();
  if ((((int)threadIdx.x) >> 5) == 0) {
    tl::initialize_tcgen05_descriptor(desc_a, (&(((bfloat16_t*)buf_dyn_shmem)[0])), 1, 64, 0, 0, 2);
    ...
    for (int ki_3 = 0; ki_3 < 8; ++ki_3) {
      tl::tcgen05mma_ss<tl::DataType::kBFloat16>(uint64_t(desc_a + (((ki_3 >> 2) * 16384) + ((ki_3 & 3) * 32))), uint64_t(desc_b + (ki_3 * 2048)), (*reinterpret_cast<uint32_t*>(C_tmem)) + 0, 1, static_cast<uint32_t>(136381584), 0, 0, 0, 0);
    }
    tl::tcgen05_mma_arrive((&(mbar[0])));
  }
  mbar[0].wait(1);
